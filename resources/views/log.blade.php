                            ...
                            <div class="col-6 text-left border-r">
                                <div class="js-appear-enabled animated fadeInLeft" data-toggle="appear"
                                    ...
                                    <div class="font-size-h3 font-w600 text-info"><img
                                            src="http://localhost/kureha-log/public/media/photos/{{$g->guildDataCountryCodeA}}.png"> </img>{{ $g->guildDataNameA }}
                                    </div>
                            ...
                            <div class="col-6 text-right">
                                <div class="js-appear-enabled animated fadeInRight" data-toggle="appear"
                                    ...
                                    <div class="font-size-h3 font-w600 text-success"><img
                                            src="http://localhost/kureha-log/public/media/photos/{{$g->guildDataCountryCodeB}}.png"> </img>{{ $g->guildDataNameB }}
                                    </div>
                                    ...
                                    <div class="block-content">
                                        <a href="{{ route('show.grid', [$a->userId, $ide]) }}"
                                           class="btn btn-xs btn-info modalMd" target="_blank">
                                            <div class="font-size-md text-black mb-5">View {{$a->name}} (Kurelog Ver)
                                            </div>
                                        </a>

                                        <a href="#"
                                           class="btn btn-xs btn-info modalMd">
                                            <div class="font-size-md text-black mb-5">View {{$a->name}} (Sinoalice Ver) Coming soon
                                            </div>
                                        </a>
